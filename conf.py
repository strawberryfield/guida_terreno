...
# -*- coding: utf-8 -*-
#
# MSTS/OR Terrain Guide by Roberto Ceccarelli - The Strawberry Field
...
man_pages = [
    (master_doc, 'terrain_guide', 'Guida creazione terreno',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'terrain_guide', 'Guida creazione terreno',
   author, 'terrain_guide', 'Guida alla creazione terreno per MSTS/OR',
   'Miscellaneous'),
]
...
epub_exclude_files = ['search.xhtml','genindex.xhtml']
